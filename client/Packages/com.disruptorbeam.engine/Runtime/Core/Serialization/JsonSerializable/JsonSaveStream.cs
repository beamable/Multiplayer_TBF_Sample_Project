...
namespace Beamable.Serialization
{
   public partial class JsonSerializable
   {
      ...
      public class JsonSaveStream : ClassPool<JsonSaveStream>, IStreamSerializer
      {
         ...
         protected void AppendNumericValue(ulong number)  { _builder.Concat(number); AppendSeperator(); }
         protected void AppendNumericValue(long number)   { _builder.Concat(number); AppendSeperator(); }
         protected void AppendNumericValue(uint number)   { _builder.Concat(number); AppendSeperator(); }
         protected void AppendNumericValue(int number)    { _builder.Concat(number); AppendSeperator(); }
         protected void AppendNumericValue(ushort number) { _builder.Concat(number); AppendSeperator(); }
         protected void AppendNumericValue(short number)  { _builder.Concat(number); AppendSeperator(); }
         protected void AppendNumericValue(byte number)   { _builder.Concat(number); AppendSeperator(); }
         protected void AppendNumericValue(float number)  { _builder.Concat(number, FloatPrecision); AppendSeperator(); }
         protected void AppendNumericValue(double number) { _builder.Concat(number, FloatPrecision); AppendSeperator(); }
