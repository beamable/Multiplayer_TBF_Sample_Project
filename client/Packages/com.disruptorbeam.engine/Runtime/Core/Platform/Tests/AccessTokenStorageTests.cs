...
namespace Beamable.Platform.Tests
{
   public class AccessTokenStorageTests
   {
      ...
      private string DeviceTokensKey => $"{Prefix}device-tokens";
      ...
      public void CanGetMany()
      {
         ...
         var value = _storage.RetrieveDeviceRefreshTokens();
      ...
      public void CanDeleteAll()
      {
         ...
         _storage.ClearDeviceRefreshTokens();
      ...
      public void CanAddMany()
      {
         ...
         tokens.ForEach(_storage.StoreDeviceRefreshToken);
      ...
      public void CanOverwriteBasedOnRefresh()
      {
         ...
         _storage.StoreDeviceRefreshToken(at);
      ...
      {
         PlayerPrefs.SetString(DeviceTokensKey, "token1|test1,token2|test2");
         _storage.RemoveDeviceRefreshToken(new TokenResponse
         {
            access_token = "token2",
            refresh_token = "test2"
         });
