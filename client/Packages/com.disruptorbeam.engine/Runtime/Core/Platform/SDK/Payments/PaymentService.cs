...
namespace Beamable.Api.Payments
{
   ...
   public class PaymentService
   {
      ...
      public PaymentService (PlatformService platform, PlatformRequester requester)
      {
         _platform = platform;
   ...
   public class Price
   {
      ...
      {
         return ServiceManager.Resolve<PlatformService>().PaymentDelegate?.GetLocalizedPrice(symbol) ?? "";
      }
