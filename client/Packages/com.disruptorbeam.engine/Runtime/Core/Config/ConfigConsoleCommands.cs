...
namespace Beamable.Config
{
    ...
    {
        public DBeamConsole Console => ServiceManager.Resolve<DBeamConsole>();
        ...
        [DBeamConsoleCommand(nameof(Config), "Manipulate config values.","CONFIG [list | get <name> | set <name> <value> | reset [name] | usefile [filename]]")]
