...
//                }
    ...
    public class MSDFPropertyCollection
    {
        ...
        private const string DEFAULT_MSDF_ASSET_PATH =
            "Packages/com.disruptorbeam.engine/Runtime/DisruptorEngine/UI/Sprites/MSDF/square.png";
...
//            }
    ...
    public static class MSDFMaterialManager
    {
        private const string MSDF_SHADER_PATH =
            "Packages/com.disruptorbeam.engine/Runtime/DisruptorEngine/UI/Materials/BeamableMSDF.shader";
