...
using Beamable.Modules.Theme.Appliers;
...
namespace Beamable.Editor.Modules.Theme
{
   public class ThemeWindow : EditorWindow
   {
      [MenuItem(
         ...
         ContentConstants.THEME_MANAGER,
         priority = ContentConstants.MENU_ITEM_PATH_WINDOW_PRIORITY_2 + 5)]
      static void Init()
      {
         var inspector = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.InspectorWindow");
         GetWindow<ThemeWindow>(ContentConstants.THEME_MANAGER, true,  inspector);
