...
// Not fit for end users - chrisa
      ...
      [MenuItem(
         ContentConstants.MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_THEME_MANAGER + "/" +
         ContentConstants.OPEN + " " +
         ContentConstants.BUSS,
      ...
      public static BussWindow Init()
      {
         ...
         BussWindow wnd = GetWindow<BussWindow>(ContentConstants.BUSS, true, inspector);
         return wnd;
      }
      public const string BUSS_PACKAGE_PATH = "Packages/com.disruptorbeam.engine/Editor/UI/Buss";
