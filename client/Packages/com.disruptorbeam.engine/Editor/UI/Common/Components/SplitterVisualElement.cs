...
// https://unity3d.com/legal/licenses/Unity_Reference_Only_License
    ...
    {
        const int kDefaultSplitSize = 30;
...
namespace Beamable.Editor.UI.Components
{
  ...
  class SplitterVisualElement : VisualElement // XXX: Taken from Unity 2018.
  {
    ...
    private const int kDefaultSplitSize = 30;
    public Action<List<float>> OnFlexChanged;
    ...
    public class UxmlFactory : UnityEngine.Experimental.UIElements.UxmlFactory<SplitterVisualElement,
