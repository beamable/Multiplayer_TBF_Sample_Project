...
namespace Beamable.Editor.Content
{
   public class EditorContentQuery : ContentQuery
   {
      ...
      protected static Dictionary<string, ContentQueryParser.ApplyParseRule<EditorContentQuery>> EditorRules;
      protected static List<ContentQueryParser.SerializeRule<EditorContentQuery>> EditorSerializeRules;
      static EditorContentQuery()
      {
         EditorRules = new Dictionary<string, ContentQueryParser.ApplyParseRule<EditorContentQuery>>
         {
         ...
         EditorSerializeRules = new List<ContentQueryParser.SerializeRule<EditorContentQuery>>
         {
      ...
      {
         return ContentQueryParser.Parse(text, EditorRules);
      }
      ...
      {
         return ContentQueryParser.ToString(existing, this, EditorSerializeRules, EditorRules);
      }
