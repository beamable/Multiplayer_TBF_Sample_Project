...
{
    public class SearchBarVisualElement : ContentManagerComponent
    {
        ...
        public SearchBarVisualElement() : base(nameof(SearchBarVisualElement))
        {
            Refresh();
        ...
        private void OnEditorUpdate()
        {
            ...
            {
                Debug.Log("Emitting change event. " + _textField.value);
