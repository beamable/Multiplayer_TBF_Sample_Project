...
namespace Beamable.Editor.Content.Components
{
   ...
   public class ContentTypeViewVisualElement : ContentManagerComponent
   {
      ...
      public override void Refresh()
      {
         ...
         _headerVisualElement.Headers = new []{ContentManagerContants.ContentTypeViewHeaderText};
         ...
         IMGUIContainer imguiContainer = CreateTreeViewIMGUIContainer(_treeViewIMGUI);
         _mainVisualElement.Add(imguiContainer);
         imguiContainer.RegisterCallback<MouseDownEvent>(IMGUIContainer_OnMouseDownEvent,
      ...
      private TreeViewIMGUI CreateTreeViewIMGUI()
      {
         ...
         treeViewIMGUI.SelectionType = ContentManagerContants.ContentTypeViewSelectionType;
      ...
      private void ContentVisualElement_OnContextMenuOpen(ContextualMenuPopulateEvent evt)
      {
         ...
         string actionTitle = string.Format(ContentManagerContants.CreateNewPopupAddButtonEnabledText,
