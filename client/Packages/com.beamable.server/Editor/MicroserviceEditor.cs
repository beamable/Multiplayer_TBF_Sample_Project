...
namespace Beamable.Server.Editor
{
   ...
   public static string dockerlocation = "/usr/local/bin/docker";
      ...
      private const string MENU_TOGGLE_AUTORUN = ContentConstants.MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_MICROSERVICES + "/Auto Run Local Microservices";
      private const int MENU_TOGGLE_PRIORITY = ContentConstants.MENU_ITEM_PATH_WINDOW_PRIORITY_3;
